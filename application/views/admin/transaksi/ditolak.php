          ...
          <div class="container-fluid">
            <div class="page-header-content">
              <h1 class="page-header-title">
                ...
                <span>Pesanan yang ditolak</span>
              </h1>
            </div>
          </div>
        </div>
                  ...
                  <tbody>
                    ...
                    foreach ($ditolak as $data) { ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-datatable btn-icon btn-transparent-dark" href="<?php echo base_url('admin/Transaksi/detailDitolak/' . $data['idTransaksi']) ?>"><i data-feather="eye"></i></a>
                          </td>
                        </tr>
