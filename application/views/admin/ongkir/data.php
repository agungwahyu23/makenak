        ...
        <div class="container-fluid mt-n10">
          <div class="card mb-4">
            <div class="card-header">
              <a class="btn btn-primary btn-sm shadow-sm mr-3" href="<?php echo base_url('admin/Ongkir/add') ?>">
                Tambah Wilayah Pengiriman
              </a>
            </div>
            <div class="card-body">
              <div class="col">
                  ...
                  <?php $i= 1; foreach($kategori as $data ) {?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a class="btn btn-datatable btn-icon btn-transparent-dark" href="<?php echo base_url('admin/Ongkir/edit/'. $data['id']) ?>"><i data-feather="edit-2"></i></a>
                          <a class="btn btn-datatable btn-icon btn-transparent-dark" onclick="confirm_hapus('<?php echo base_url('admin/Ongkir/hapus/' . $data['id']) ?>')" data-toggle="modal" data-target="#modalDelete"><i data-feather="trash-2"></i></a>
                        </td>
                      </tr>
                    <?php $i++; }?>
                  </tbody>
