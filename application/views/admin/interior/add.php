          ...
          <div class="container-fluid">
            <div class="page-header-content">
              <h1 class="page-header-title">
                ...
                <span>Tambah Desain Interior</span>
              </h1>
            </div>
          </div>
        </div>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="form-group col-lg-6 col-sm-12">
                    ...
                    <input class="form-control" name="id_desain_interior" type="hidden" placeholder="" value="<?= $kd ?>" />
                  </div>
                  ...
                  <div class="form-group col-lg-6 col-sm-12">
                    ...
                    <select class="form-control" name="kategori">
                      ...
                      <?php foreach ($kategori as $k) : ?>
                        <option value="<?= $k['id_kategori_interior']; ?>"><?= $k['nama_kategori']; ?></option>
                      <?php endforeach; ?>
                    </select>
                  </div>
                </div>
