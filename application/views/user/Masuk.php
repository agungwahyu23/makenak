          ...
          <div class="col-lg-5">
            <div class="card shadow-lg border-0 rounded-lg mt-15">
              <div class="card-header justify-content-center">
                <h5>Silahkan Login, Untuk Memulai Berbelanja.</h5>
              </div>
              <div class="card-body">
                <div class="col">
                <?php echo $this->session->flashdata('message') ?>
                  <form action="" method="post">
                    ...
                    <div class="col-md-12"><label class=" mb-1" for="password">Password</label>
              ...
              <div class="card-footer text-center">
                <div class="small"><a href="<?= base_url('Auth/Daftar') ?>">Belum Punya Akun? Daftar Disini</a></div>
              </div>
            </div>
          </div>
