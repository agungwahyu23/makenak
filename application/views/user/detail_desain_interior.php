          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                  <div class="swiper-slide">
                    <img src="<?= base_url('uploads/Desain_Interior/' . $t['foto']) ?>" alt="">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4">
              ...
              <?php foreach ($deskripsi as $d) : ?>
                <button type="submit" class="btn btn-primary" type="button" onclick="window.open('https://api.whatsapp.com/send?phone=<?= $d['No_Telp'] ?>&text=saya%20tertarik%20dengan%20desain%20interior%20dengan%20nama%20desain%20interior%20<?= $t['nama'] ?>')">Hubungi Admin</button>
              <?php endforeach; ?>
            ...
            <?php foreach ($lain as $l) : ?>
              <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <div class="portfolio-wrap">
                  <img src="<?= base_url('uploads/Desain_Interior/' . $l['foto']) ?>" class="img-fluid" alt="">
                  <div class="portfolio-info">
                    <h4><?= $l['nama']; ?></h4>
                    <p><?= $l['nama_kategori']; ?></p>
                    <div class="portfolio-links">
                      <a href="<?= base_url('uploads/Desain_Interior/' . $l['foto']) ?>" data-gallery="portfolioGallery" class="portfokio-lightbox" title="<?= $l['nama']; ?>"><i class="bi bi-zoom-in"></i></a>
                      <a href="<?= base_url('DetailDesainInterior/Index/') . $l['id_desain_interior'] ?>" title="Lihat Detail"><i class="bi bi-plus"></i></a>
                    </div>
                  </div>
                </div>
              </div>
